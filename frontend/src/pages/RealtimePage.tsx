...
export function RealtimePage() {
  ...
  async function startRecording() {
    ...
    try {
      // Brauzer DSP'sini yoqamiz — eko/shovqin bostirish + avto-kuchaytirish.
      // Bu Yandex STG'a TOZA signal beradi → tanish sezilarli yaxshilanadi
      // (call-ai loyihasi shu sozlamalar bilan ishlaydi). 16k mono so'raymiz.
    ...
    // Mikrofon shovqin filtri (brauzer DSP'si ustiga): past gum/rumble (HP 90Hz),
    // yuqori hiss/shitirlash (LP 7500Hz), kompressor (ovoz sathini tekislash) →
    // Yandex STT'ga yanada toza signal.
