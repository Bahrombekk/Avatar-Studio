...
class StreamingSTT:
    ...
    def _requests(self):
        ...
        #    EOU klassifikatori: gap oxirini aniqlaydi → qisqa iboralar erta
        #    kesilmaydi (call-ai loyihasidagi sozlama). text_normalization O'ZBEK
        #    uchun ZARARLI bo'ldi (so'zlarni noto'g'ri "tuzatdi") — qo'shilmaydi.
